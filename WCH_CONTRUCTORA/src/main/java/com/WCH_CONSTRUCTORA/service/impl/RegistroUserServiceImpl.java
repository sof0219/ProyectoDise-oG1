...
import com.WCH_CONSTRUCTORA.services.CorreoService;

import com.WCH_CONSTRUCTORA.services.RegistroUserService;
import com.WCH_CONSTRUCTORA.services.UsuarioService;
...
@Service
public class RegistroUserServiceImpl implements RegistroUserService {
        ...
        if (usuario != null) {
            ...
            model.addAttribute(
                    ...
                    messageSource.getMessage(
                            "registroUser.activar", 
                            null,  Locale.getDefault()));
            model.addAttribute(
                    "mensaje", 
                    messageSource.getMessage(
                            "registroUser.activar.error", 
                            null, Locale.getDefault()));
        }
        return model;
    }
    ...
    public Model crearUsuario(Model model, Usuario usuario) 
        ...
        if (!usuarioService.
            ...
            mensaje = String.format(
                    messageSource.getMessage(
                            "registroUser.mensaje.activacion.ok", 
                            null, 
                            Locale.getDefault()),
                    usuario.getCorreo());
        } else {
            mensaje = String.format(
                    messageSource.getMessage(
                            "registroUser.mensaje.usuario.o.correo", 
                            null, 
                            Locale.getDefault()),
    ...
    public Model recordarUsuario(Model model, Usuario usuario) 
        ...
        if (usuario2 != null) {
            ...
            mensaje = String.format(
                    messageSource.getMessage(
                            "registroUser.mensaje.recordar.ok", 
                            null, 
                            Locale.getDefault()),
                    usuario.getCorreo());
        } else {
    ...
    private void enviaCorreoActivar(Usuario usuario, String clave) throws MessagingException {
        ...
        String asunto = messageSource.getMessage(
                "registroUser.mensaje.activacion", 
                null, Locale.getDefault());
